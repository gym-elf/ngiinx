...
Склонируйте репозиторий из-под стандартного пользователя:

```
git clone https://github.com/gym-elf/ngiinx.git
```

Убедитесь, что у текущего пользователя выставлены все необходимые права для взаимодействия с директориями и он находится в группе sudo, docker.
...
Каталог "src/" содержит официальный исходный код nginx, добавленный в репозиторий для удобства сборки проекта.

Исходный код не модифицировался.
